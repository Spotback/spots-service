...
export const SPOTS_NA = "N0 SPOTS FOUND.";
...
export const CITY_NOT_SUPPORTED = 'CITY IS NOT SUPPORTED YET.';
export const ONE_SPOT_PER_HOUR = 'YOU CAN ONLY POST 1 SPOT PER HOUR.';
